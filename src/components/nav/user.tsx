...
const UserCard = () => {
  return (
    <Card shadow="none" className="border-none min-w-[250px] max-w-[300px] bg-transparent">
      <CardHeader className="justify-between">
        <div className="flex gap-3">
          ...
          <div className="flex flex-col items-start justify-center">
            <h4 className="text-small font-semibold leading-none">Guest User</h4>
            <h5 className="text-xs font-medium tracking-tight text-success">Guest</h5>
          </div>
        </div>
      </CardHeader>
